...
const url =
  "https://api.openweathermap.org/data/2.5/weather?lat=32.50310852801206&lon=-117.00470232465491&appid=bf0dd84c28e62391c7294fb52233ed70&units=metric";
...
const displayResults = (data) => {
  data.weather.forEach((w) => {
    ...
    showMaxtemp.innerHTML = `Today's max temp: ${Math.round(
      data.main.temp_max
    )}&deg;C`; // caracter especial para grados
